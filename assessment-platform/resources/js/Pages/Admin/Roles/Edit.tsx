...
export default function Edit({ role, permissionGroups }: { role: RoleData; permissionGroups: Record<string, string[]> }) {
    ...
    return (
        <AdminLayout>
            ...
            <div className="mb-6">
                ...
                <h2 className="mt-2 text-2xl font-bold text-gray-900">Edit Role: {role.name}</h2>
            </div>
            ...
            <form onSubmit={submit} className="max-w-3xl">
                ...
                <div className="mt-6 flex items-center gap-4">
                    <PrimaryButton disabled={processing}>Update Role</PrimaryButton>
