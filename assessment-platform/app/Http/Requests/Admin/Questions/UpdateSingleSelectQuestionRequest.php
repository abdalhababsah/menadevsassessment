...
final class UpdateSingleSelectQuestionRequest extends FormRequest
{
    ...
    public function after(): array
    {
        return [
            function (Validator $validator): void {
                ...
                if ($correctCount !== 1) {
                    $validator->errors()->add('options', 'Single-select questions must have exactly 1 correct option.');
                }
            },
        ];
    }

    public function toData(): SingleSelectQuestionData
    {
        $validated = $this->validated();

        return SingleSelectQuestionData::from([
            'stem' => $validated['stem'],
